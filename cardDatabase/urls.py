...
urlpatterns = [
    ...
    path('user_lock_decklist/<int:decklist_id>/', views.user_lock_decklist, name='cardDatabase-user-lock-decklist'),
    path('user_unlock_decklist/<int:decklist_id>/', views.user_unlock_decklist, name='cardDatabase-user-unlock-decklist'),
    ...
    path('locked_decklist/', views.locked_decklist, name='cardDatabase-locked-decklist'),
